                    ...
                    <div class="info">
                        ...
                        <div class="more">
                            <a href="#addQuestion_modal" data-toggle="modal" type="button">
                                <s:text name="admin.listQuestionQCM.addQuestion"/> <i class="glyphicon glyphicon-plus"></i>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="info">
                            ...
                            <div class="more">
                                <a href="#editQuestion_modal" data-toggle="modal" type="button" data-whatever="<s:property value="idQuestion"/>">
                                    <s:text name="admin.listQuestionQCM.editQuestion"/> <i class="glyphicon glyphicon-pencil"></i>
                                </a>
                            </div>
                        </div>
                    </div>
